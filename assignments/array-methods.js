...
// Problem 1 Create a new list of all of the people who donated more than 250 bucks

const bigMoney = runners.filter(function(currentValue){
    return currentValue.donation > 250;
    
});

console.log(bigMoney);

// Problem 2 Create an email list of all donors for a thank you letter

const emailList = [];
runners.forEach(function(currentValue){
emailList.push("first name: " + currentValue.first_name + " email: " + currentValue.email)
});

console.log(emailList);

// Problem 3 Create an array of all last names in lower case
